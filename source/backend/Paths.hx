...
class Paths
{
    ...
    {
        #if MODS_ALLOWED
        if(modsAllowed && parentfolder != null)
        {
            var customFile:String = 'images/$file'; // Asumimos que los activos de imagen están en una subcarpeta "images"
            var modded:String = mods(parentfolder + '/' + customFile);
