...
function onCustomSubstateCreate(n)
	if n == 'pause' then
		...
		makeLuaSprite('render', 'pause/endrender', screenWidth)
		scaleObject('render', 2, 2)
		setProperty('render.antialiasing', false)
		setProperty('render.y', screenHeight - getProperty('render.height'))
