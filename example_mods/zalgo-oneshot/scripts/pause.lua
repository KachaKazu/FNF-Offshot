...
function onCreate()
	...
	precacheImage('pause/zalgorender')
...
function onCustomSubstateCreate(n)
	if n == 'pause' then
		...
		makeLuaSprite('render', 'pause/zalgorender', screenWidth)
		scaleObject('render', 1.7, 1.7)
		setProperty('render.antialiasing', false)
		setProperty('render.y', screenHeight - getProperty('render.height') + 50)
