-- Custom Resolution script by Stilic
-- Please credit me if used for your mods!!
local gameWidth, gameHeight = 822, 720
...
function onCreate()
    ...
    setPropertyFromClass("openfl.Lib", "application.window.title", "DOMINION")
